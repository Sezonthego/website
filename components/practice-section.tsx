  ...
  return (
    <section className="border-y border-brand-border bg-brand-ivory">
      <Container className="px-0">
        ...
        <h2 className="mx-auto max-w-6xl font-heading text-[clamp(2rem,4vw,3rem)] font-[300] leading-[1.2] tracking-[-0.02em] text-brand-cocoa">
  Built to adapt around your research needs.
</h2>

<p className="mx-auto mt-6 max-w-[680px] font-body text-base font-light leading-[1.7] text-brand-muted md:text-[17px]">
...
<Link
  href="/contact"
  className="mt-12 inline-flex min-h-14 items-center rounded-none bg-brand-orange px-5 py-3 text-base font-normal text-brand-ivory shadow-[0_14px_30px_rgba(255,79,0,0.20)] transition-colors hover:bg-brand-orange/90 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-orange focus-visible:ring-offset-2 focus-visible:ring-offset-brand-ivory sm:px-6 md:mt-16"
>
